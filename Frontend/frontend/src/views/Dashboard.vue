  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition mt-8">
      ...
      <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
        This is a full-featured Admin Dashboard built using <strong>Vue 3</strong> and <strong>Tailwind CSS</strong> with a <strong>Node.js</strong> and <strong>MongoDB</strong> backend. It provides real-time metrics for total orders, revenue, and active products through dynamic API integration. Built with performance, simplicity, and dark mode in mind.
      </p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow hover:shadow-lg transition flex flex-col sm:flex-row items-center sm:items-start gap-6">
      ...
      <div>
        ...
        <ul class="text-sm text-gray-700 dark:text-gray-400 space-y-1">
          <li><strong>Email:</strong><a href="mailto:mohammad.fawad.564@gmail.com"> mohammad.fawad.564@gmail.com</a> </li>
